...
class StartMenuWindow(QMainWindow):
    def __init__(self):
        ...
        for i in range(len(self.start_menu)):
            ...
            self.Layout.addWidget(self.start_menu_button,i+1,0)
